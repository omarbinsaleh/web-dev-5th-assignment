// resetButtonColor() function defination:
...
function createHistoryLog(log) {
   ...
   historyElement.innerHTML = `
      <div class="history-log p-3 space-y-1 border border-gray-400 shadow-md rounded">
...
function showModal(amount) {
   ...
   <div>
      <button id="hide-modal-1" class="btn hover:bg-red-500 hover:text-white cursor-pointer">
         Close Confirmation
      </button>
   </div>
   `;
